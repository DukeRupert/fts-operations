...
<div
	class="relative {$isLoading ? 'z-10' : '-z-10'}"
...
>
	<div
		class="{$isLoading
			...
			: 'ease-in duration-200 opacity-0'} fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"
	/>
      ...
      -->
			...
			>
				...
				<div class="mt-5 sm:mt-6">
					<button
						type="button"
						on:click|preventDefault={() => ($isLoading = false)}
